        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div className="service-item item-cyan position-relative">
              ...
              <p>Lead generation is the process of attracting and converting potential customers into interested prospects for your products or services. It involves strategies like email marketing, social media outreach, and targeted campaigns to drive sales growth.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div className="service-item item-orange position-relative">
              ...
              <p>Email marketing is a digital strategy used to promote products or services through targeted email campaigns. It helps nurture leads, engage customers, and drive conversions with personalized messaging.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div className="service-item item-teal position-relative">
              ...
              <p>A marketing strategy is a comprehensive plan designed to promote a product or service and achieve business goals. It involves market research, audience targeting, and the effective use of channels to maximize reach and impact.</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div className="service-item item-red position-relative">
              ...
              <p>Search Engine Optimization (SEO) is the process of improving a website’s visibility on search engines like Google to attract organic traffic. It involves optimizing content, keywords, and technical elements to rank higher in search results.</p>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div className="service-item item-indigo position-relative">
              ...
              <p>Demand generation is a marketing approach focused on creating awareness and interest in a company's products or services. It combines content, campaigns, and data-driven strategies to attract and engage potential buyers throughout the sales funnel.</p>
              <a href="#" className="stretched-link"></a>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div className="service-item item-pink position-relative">
              ...
              <p>IT consulting provides expert advice and solutions to businesses on how to effectively use technology to meet their goals. It involves assessing IT systems, optimizing infrastructure, and implementing strategic tech improvements.</p>
              <a href="#" className="stretched-link"></a>
            </div>
          </div>
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
